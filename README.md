...
The Node daemon and CLI are published as [`openbucket@0.1.15`](https://www.npmjs.com/package/openbucket/v/0.1.15), and the web application is live at [openbucket-eight.vercel.app](https://openbucket-eight.vercel.app). Release `0.1.15` is the current unified trusted release for npm, PyPI, GitHub Container Registry, and GitHub Releases; see [Releasing](docs/RELEASING.md).
