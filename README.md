...
The Node daemon and CLI are published as [`openbucket@0.1.23`](https://www.npmjs.com/package/openbucket/v/0.1.23), and the web application is live at [openbucket.zydcode.in](https://openbucket.zydcode.in). Release `0.1.23` is the current unified trusted release for npm, PyPI, GitHub Container Registry, and GitHub Releases; see [Releasing](docs/RELEASING.md).
